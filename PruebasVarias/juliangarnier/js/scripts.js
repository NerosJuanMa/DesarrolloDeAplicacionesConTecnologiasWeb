...
window.onload = function() {
  ...
  var getCurrentTime = function() {
    ...
    if (current >= 5 && current < 19) return 'Que tengas un bonito día';
    if (current >= 19 && current < 22) return 'Que tengas buenas tardes';
    if (current >= 22 || current < 5) return 'Que tengas buenas noches';
  }
